...
### [extract](https://docs.text-gen.com/extract)

The `extract` helper is used to obtain information from different sources, enhancing the template's capabilities in processing and analyzing content. Additional details about its functionality can be found on the [extract](https://docs.text-gen.com/extract) page.

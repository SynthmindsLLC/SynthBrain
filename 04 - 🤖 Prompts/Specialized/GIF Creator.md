...
## Step 1 (DALL-E)
## MISSION 
Act as a professional 8-bit animator who specializes in creating animals. Create a **side-view** sprite sheet with 4 different, square frames of a [bat], [flying] in a [forest], 8-bit, motion blur, brown-core. Your task is complete when there is a single image with 4 panels as described below. 
## IMAGES 

...
type Filter = { source?: string; collection?: string };
...
export function HUD({
  ...
  const collections = useMemo(
    () => graph.nodes.filter((n) => n.kind === 'collection'),
    [graph],
  );
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <strong style={{ color: '#7dd3fc' }}>SynthBrain</strong> · {graph.note_count} notes ·{' '}
          {graph.collection_count} collections
      ...
      {open && (
        ...
        >
          ...
          <div>
            <div style={{ color: '#7dd3fc', marginBottom: 6, fontWeight: 600 }}>By collection</div>
            <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
              <FilterChip
                label="All"

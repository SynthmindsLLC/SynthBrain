...
Enable request logging. · boolean
...
How much we should optimize streaming request latency (time to first audio byte). · integer
...
Output format of the generated audio. · string
...
Body\_Text\_to\_speech\_with\_timestamps\_v1\_text\_to\_speech\_\_voice\_id\_\_with\_timestamps\_post · object
...
voice\_settings.stability

number

required

voice\_settings.similarity\_boost

number

required

voice\_settings.style

number

default: 0

voice\_settings.use\_speaker\_boost
...
[Suggest edits](https://github.com/elevenlabs/elevenlabs-docs/edit/main/api-reference/text-to-speech-with-timestamps.mdx)[Raise issue](https://github.com/elevenlabs/elevenlabs-docs/issues/new?title=Issue on docs&body=Path: /api-reference/text-to-speech-with-timestamps)

[Text To Speech](/docs/api-reference/text-to-speech)[Streaming](/docs/api-reference/streaming)

...
[Suggest edits](https://github.com/elevenlabs/elevenlabs-docs/edit/main/api-reference/getting-started.mdx)[Raise issue](https://github.com/elevenlabs/elevenlabs-docs/issues/new?title=Issue on docs&body=Path: /api-reference/getting-started)

[How to use text to speech](/docs/api-reference/how-to-use-tts-with-streaming)
...
*   [Fetching the voice\_id](#fetching-the-voice-id)

...
The easiest way to upgrade from the Text Completions API to the Messages API is to use our web [Console](https://console.anthropic.com/) to convert your prompts. By using the Console, you can quickly and easily migrate your prompts and requests to the Messages API without having to manually rewrite your code.
...
1\. Go to the [Console](https://console.anthropic.com/) and select the model you want to use
...
This is also where you can adjust any additional parameters as needed, such as temperature and maximum tokens to sample. For more information about our parameters, see the [Messages API documentation](/en/api/messages).
...
2\. Transfer your prompt into the appropriate [Console](https://console.anthropic.com/) message fields
...
Without using the [Console](https://console.anthropic.com/), transitioning this prompt would require you to rewrite your code entirely into the Messages API. However, dropping the separate parts of your prompt (system prompt & user prompt) into the corresponding Console fields allows you to extract correct pre-formatted code out of the box.

In the Console, the above prompt would look like this:

![](https://mintlify.s3-us-west-1.amazonaws.com/anthropic/images/ffaec3b-Example_Prompt.png)
...
> **Note**: The [Console](https://console.anthropic.com/) does not yet allow you to [prefill Claude’s response](/en/docs/prefill-claudes-response) (i.e., prefilling text in the `Assistant` turn), but the underlying Messages API does. See our guide on [prefilling Claude’s response](/en/docs/prefill-claudes-response#how-to-prefill-claudes-response) for examples on how to format a Messages API request with this technique.
...
If you’re currently using a different AI platform or model and want to switch to Claude with the Messages API, we’ve created a comprehensive guide to help you through the process. See [migrating from other models](/en/docs/migrating-from-other-models) for detailed instructions on how to adapt your prompts and code to our platform.
...
*   [Messages API documentation](/en/api/messages)
*   [\[Legacy\] Text Completions API documentation](/en/api/complete)

If you have any questions or need further assistance with upgrading to the Messages API, please don’t hesitate to reach out to our [support team](https://support.anthropic.com/). We’re here to help you make the most of our AI capabilities and ensure a smooth transition to Claude.

[Migrating from other models](/en/docs/migrating-from-other-models)[Overview](/en/docs/models-overview)

[x](https://x.com/AnthropicAI)[linkedin](https://www.linkedin.com/company/anthropicresearch)

*   [Why upgrade to the Messages API?](#why-upgrade-to-the-messages-api)
*   [How to upgrade to the Messages API](#how-to-upgrade-to-the-messages-api)
*   [1\. Go to the Console and select the model you want to use](#1-go-to-the-console-and-select-the-model-you-want-to-use)
*   [2\. Transfer your prompt into the appropriate Console message fields](#2-transfer-your-prompt-into-the-appropriate-console-message-fields)
*   [3\. Copy the pre-formatted code](#3-copy-the-pre-formatted-code)
*   [Migrating from other models](#migrating-from-other-models)

...
* **What is the overall objective?** (e.g., to increase profits, to solve a problem, to achieve a personal milestone)
* **What are the key values or principles that guide this mission?** (e.g., innovation, customer satisfaction, sustainability)

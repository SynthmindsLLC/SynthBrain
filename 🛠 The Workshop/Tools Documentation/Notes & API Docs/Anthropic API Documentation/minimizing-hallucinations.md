...
While Claude is incredibly powerful and versatile, it can sometimes generate text that is factually incorrect, inconsistent, or irrelevant to the given context.

This phenomenon is known as “hallucination” and can occur when the model tries to fill in gaps in its knowledge or when the input is ambiguous.
...
| Role | Content |
| --- | --- |
| User | Consider the following document:  
<document>  
{{DOCUMENT}}  
<document>  
...
You can further utilize the direct quotes that Claude extracts by telling Claude to answer only if there is relevant information found on those quotes, or to ground its answer only in the information found in the extracted quotes. See this example citation-based prompt from our [prompt library](/en/prompt-library):
...
<example>  
Quotes:  
\[1\] “Company X reported revenue of 12 million in 2021." <br/> \\\[2\\\] "Almost 90% of revene came from widget sales, with gadget sales making up the remaining 10%. <br/> <br/> "Answer: <br/> Company X earned 12 million. \[1\] Almost 90% of it was from widget sales. \[2\]  
</example>  
...
*   Give Claude room to [think before responding](/en/docs/let-claude-think).
...
If you continue to encounter issues or have questions, don’t hesitate to reach out to our [customer support](https://support.anthropic.com/) team.

[Overview](/en/docs/troubleshooting)[Mitigating jailbreaks & prompt injections](/en/docs/mitigating-jailbreaks-prompt-injections)

[x](https://x.com/AnthropicAI)[linkedin](https://www.linkedin.com/company/anthropicresearch)

*   [Allow Claude to say “I don’t know”](#allow-claude-to-say-i-dont-know)
*   [Ask Claude for direct quotes](#ask-claude-for-direct-quotes)
*   [Other strategies to minimize hallucinations](#other-strategies-to-minimize-hallucinations)
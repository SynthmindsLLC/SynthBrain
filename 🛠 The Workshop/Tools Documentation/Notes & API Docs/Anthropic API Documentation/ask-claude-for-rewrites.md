...
*   You are unsure if the result is accurate and want Claude to double check to make sure (consider it a mini one-off [LLM-graded eval](/en/docs/empirical-performance-evaluations#eval-grading-methods))
...
When sending requests through the API (including the functions in [Claude for Sheets](/en/docs/google-sheets-add-on)), you must always include the previously generated text in your prompt. Here’s an example prompt template:

| Role | Prompt |
| --- | --- |
| User | Here’s a paragraph:  
<paragraph>  
{{PARAGRAPH}}  
</paragraph>  
...
[Control output format (JSON mode)](/en/docs/control-output-format)[Long context window tips](/en/docs/long-context-window-tips)

[x](https://x.com/AnthropicAI)[linkedin](https://www.linkedin.com/company/anthropicresearch)

*   [When to ask for a rewrite](#when-to-ask-for-a-rewrite)
*   [How to request a rewrite](#how-to-request-a-rewrite)
*   [Crafting effective rewrite instructions](#crafting-effective-rewrite-instructions)
*   [Iterative rewrites](#iterative-rewrites)

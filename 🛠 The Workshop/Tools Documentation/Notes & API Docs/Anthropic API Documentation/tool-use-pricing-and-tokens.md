---
Please provide me with the context or information about the mission you want to write about. 

For example, tell me: "* **What is the mission about?** (e.g., a space exploration mission, a charitable organization, a personal goal)"
* **What is the purpose of the mission?** (e.g., to find life on Mars, to help the homeless, to learn a new language)
* **Who is involved in the mission?** (e.g., a team of scientists, volunteers, an individual)
* **What are the key objectives of the mission?** (e.g., collect data, raise funds, achieve fluency)
...
340 tokens |
| Claude 3 Opus  
(legacy beta: `tools-2024-04-04`) | `auto` | 395 tokens |
...
[Tool use examples](/en/docs/tool-use-examples)[Legacy tool use](/en/docs/legacy-tool-use)

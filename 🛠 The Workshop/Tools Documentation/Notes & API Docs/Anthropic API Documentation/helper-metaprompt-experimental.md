---
Please provide me with more context! I need to know what you want the mission to be about. 
...
To help with this, we’ve created an experimental helper “meta”-prompt that can guide Claude to generate a high-quality prompts tailored to your specific tasks.

To use the metaprompt, follow the instructions in our [metaprompt Google Colab notebook](https://anthropic.com/metaprompt-notebook/). There, you can easily run the code to have Claude construct prompts on your behalf.

> Note that to run the Colab notebook, you will need an [API key](/en/docs/getting-access-to-claude).
...
[Long context window tips](/en/docs/long-context-window-tips)[Reducing latency](/en/docs/reducing-latency)

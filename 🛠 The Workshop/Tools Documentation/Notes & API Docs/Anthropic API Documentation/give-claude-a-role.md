...
2.  **Experiment and iterate:** Try different roles and variations of your prompts to find the best approach for your specific use case. Prompt engineering often involves [experimentation and iteration](/en/docs/prompt-engineering#the-prompt-development-lifecycle) to achieve optimal results.
...
[Use examples](/en/docs/use-examples)[Use XML tags](/en/docs/use-xml-tags)

[x](https://x.com/AnthropicAI)[linkedin](https://www.linkedin.com/company/anthropicresearch)

*   [How role prompting works](#how-role-prompting-works)
*   [When to use role prompting](#when-to-use-role-prompting)
*   [Role prompting examples](#role-prompting-examples)
*   [Solving a logic puzzle](#solving-a-logic-puzzle)
*   [Explaining a concept to different audiences](#explaining-a-concept-to-different-audiences)
*   [Tips for effective role prompting](#tips-for-effective-role-prompting)

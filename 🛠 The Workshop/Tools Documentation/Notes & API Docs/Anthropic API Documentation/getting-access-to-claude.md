...
For example, you could tell me: "* **What kind of mission is it?** Is it for a company, a non-profit, a school, a personal goal, etc.? "
* **What is the general focus of the mission?** Is it about innovation, sustainability, social impact, education, etc.?
* **What are some key values or goals that the mission should reflect?** 

---
Please provide me with more context! I need to know what kind of mission you're referring to.  

For example, tell me: "* **What is the purpose of the mission?**  Is it a mission for a company, a team, a project, or something else?"
...
Once I have more information, I can help you create a compelling and informative mission statement!
---
...
Anthropic does not offer its own embedding model. One embeddings provider that has a wide variety of options and capabilities encompassing all four of the above considerations is [Voyage AI](https://www.voyageai.com/?ref=anthropic). Voyage AI makes [state of the art](https://blog.voyageai.com/2023/10/29/voyage-embeddings/?ref=anthropic) embedding models and offers customized models for specific industry domains such as finance and healthcare, or bespoke fine-tuned models for individual customers.
...
Note that we use `input_type="document"` and `input_type="query"` for embedding the document and query, respectively. More specification can be found [here](/en/docs/embeddings#voyage-python-package).
...
[Vision](/en/docs/vision)[Google Sheets add-on](/en/docs/google-sheets-add-on)

[x](https://x.com/AnthropicAI)[linkedin](https://www.linkedin.com/company/anthropicresearch)

*   [Embeddings overview](#embeddings-overview)
...
*   [How do I calculate the distance between two embedding vectors?](#how-do-i-calculate-the-distance-between-two-embedding-vectors)
*   [Can I count the number of tokens in a string before embedding it?](#can-i-count-the-number-of-tokens-in-a-string-before-embedding-it)
*   [Pricing](#pricing)
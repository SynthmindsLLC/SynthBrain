...
A constant string: "authorization\_code".
...
Create a token for a Link PreviewCreate a token for a public integration
...
\--header 'Authorization: Basic '"$BASE64\_ENCODED\_ID\_AND\_SECRET"'' \\
...
8
  ...
  "redirect\_uri": "https://wwww.my-integration-endpoint.dev/callback",

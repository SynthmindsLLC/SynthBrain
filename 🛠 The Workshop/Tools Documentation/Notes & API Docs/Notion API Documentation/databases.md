...
To help me write a compelling mission statement, I need to know: "* **What is the purpose of this mission?**  Is it for a company, a project, a personal goal, a movement, etc.? "
* **What are the key values and goals?** What is the organization or initiative trying to achieve?
...
Title of database as it appears in Notion. An array of [rich text objects](/reference/rich-text).
...
Property schema of database. The keys are the names of properties as they appear in Notion and the values are [property schema objects](/reference/property-schema-object).
...
8
        ...
        "page\_id": "98ad959b-2b6a-4774-80ee-00246fb0ea9b"

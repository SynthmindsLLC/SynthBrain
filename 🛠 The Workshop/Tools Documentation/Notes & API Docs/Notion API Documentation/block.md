...
\- [`"heading_1"`](/reference/block#heading-1)  
\- [`"heading_2"`](/reference/block#heading-2)  
\- [`"heading_3"`](/reference/block#heading-3)  
\- [`"image"`](/reference/block#image)  
\- [`"link_preview"`](/reference/block#link-preview)  
\- [`"link_to_page"`](/reference/block#link-to-page)  
...
\- `"xml"`  
\- `"yaml"`  
\- `"java/c/c++/c#"` | The language of the code contained in the code block. |
...
Columns are parent blocks for any block types listed in this reference except for other `column`s. They do not contain any information within the `column` property. They can only be appended to `column_list`s.

Example Column object

`{   //...other keys excluded   "type": "column",   //...other keys excluded   "column": {} }`
...
| `file` | [file object](/reference/file-object) | A file object that details information about the file contained in the block. |
...
`file` | [file object](/reference/file-object) | An object containing type-specific information about the PDF. |
...
`{     //...other keys excluded   	"type": "synced_block",     "synced_block": {         "synced_from": {             "block_id": "original_synced_block_id"         }     } }`
...
Video block objects contain a [file object](/reference/file-object) detailing information about the image.
...
*   [Table of Contents](#)
*   *   [Keys](#keys)
    *   [Block type objects](#block-type-objects)
        *   [Bookmark](#bookmark)
        ...
        *   [Code](#code)
        *   [Column list and column](#column-list-and-column)
        *   [Divider](#divider)
        *   [Embed](#embed)
        *   [Equation](#equation)
        *   [File](#file)

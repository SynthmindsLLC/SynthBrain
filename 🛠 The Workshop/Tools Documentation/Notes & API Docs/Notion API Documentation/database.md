...
Database objects describe the property schema of a database in Notion. [Pages](/reference/page) are the items (or children) in a database. [Page property values](/reference/page#property-value-object) must conform to the [property objects](/reference/property-object) laid out in the parent database object.
...
| `title` | array of [rich text objects](/reference/rich-text) | Name of the database as it appears in Notion.  
See [rich text object](/reference/rich-text)) for a breakdown of the properties. | `"title": [ { "type": "text", "text": { "content": "Can I create a URL property", "link": null }, "annotations": { "bold": false, "italic": false, "strikethrough": false, "underline": false, "code": false, "color": "default" }, "plain_text": "Can I create a URL property", "href": null } ]` |
| `description` | array of [rich text objects](/reference/rich-text) | Description of the database as it appears in Notion.  

...
Why should I sell templates on the marketplace?[](https://developers.hubspot.com/docs/cms/marketplace-guidelines#why-should-i-sell-templates-on-the-marketplace-)
-----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Overview and requirements[](https://developers.hubspot.com/docs/cms/marketplace-guidelines#overview-and-requirements)
---------------------------------------------------------------------------------------------------------------------

To get started selling on the Template Marketplace, [create a Template Marketplace provider account](https://app.hubspot.com/signup-hubspot/asset-provider?_gl=1*1xpzfk0*_ga*MjE0MDM5NjAwMS4xNjg3MjUxNjQz*_ga_LXTM6CQ0XK*MTY4NzMxMTYzMi4yLjAuMTY4NzMxMTYzMi42MC4wLjA.). 
...
[View theme requirements](https://developers.hubspot.com/docs/cms/marketplace-guidelines/theme-requirements)
...
[View module requirements](https://developers.hubspot.com/docs/cms/marketplace-guidelines/module-requirements)
...
[View listing page requirements](https://developers.hubspot.com/docs/cms/marketplace-guidelines/general-requirements)

### Template Marketplace Policies

Requirements and compliance details for listing templates in the Template Marketplace.

[View Template Marketplace policies](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies)

List and update themes on the Template Marketplace[](https://developers.hubspot.com/docs/cms/marketplace-guidelines#list-and-update-themes-on-the-template-marketplace)
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------

Once you've created your template, submit it for approval to be listed on the HubSpot Template Marketplace. Once submitted, templates will undergo a review and approval process by the HubSpot Template Marketplace team. [Learn how to list and update your templates in the Template Marketplace](/docs/cms/marketplace-guidelines/listing-templates). 

Supported payment gateways[](https://developers.hubspot.com/docs/cms/marketplace-guidelines#supported-payment-gateways)
-----------------------------------------------------------------------------------------------------------------------
...
*   PayPal ([supported countries](https://www.paypal.com/us/webapps/mpp/country-worldwide) | [cross border payments](https://www.paypal.com/us/smarthelp/article/what-are-the-cross-border-fees-when-selling-international-faq2927))
*   Stripe ([supported countries](https://stripe.com/global) | [cross border payments](https://stripe.com/docs/connect/cross-border-payouts))
...
Refund requests[](https://developers.hubspot.com/docs/cms/marketplace-guidelines#refund-requests)
-------------------------------------------------------------------------------------------------

You may run into the occasional request from a purchaser for a refund. HubSpot recommends clearly stating your refund policy in a listing's description and providing a link to documentation about your refund policy. HubSpot encourages providers to honor valid refund requests. Learn more about general [guidelines for refund requests](https://knowledge.hubspot.com/articles/kcs_article/resources/marketplace-refund-guidelines).

Manage your transactions[](https://developers.hubspot.com/docs/cms/marketplace-guidelines#manage-your-transactions)
-------------------------------------------------------------------------------------------------------------------
...
Providers are able to [customize the deal pipeline and deal stages,](https://knowledge.hubspot.com/crm-deals/set-up-and-customize-your-deal-pipelines-and-deal-stages) and [use the deal properties in workflows](https://knowledge.hubspot.com/workflows/choose-your-workflow-actions#property-management)[.](https://knowledge.hubspot.com/crm-deals/set-up-and-customize-your-deal-pipelines-and-deal-stages)

Removal of template listings[](https://developers.hubspot.com/docs/cms/marketplace-guidelines#removal-of-template-listings)
---------------------------------------------------------------------------------------------------------------------------
...
*   The template is incompatible with [HubSpot-supported browsers.](https://knowledge.hubspot.com/resources/which-browsers-are-supported-by-hubspot)
...
Frequently Asked Questions[](https://developers.hubspot.com/docs/cms/marketplace-guidelines#frequently-asked-questions)
-----------------------------------------------------------------------------------------------------------------------

Does the European Union P2B regulation (July 12,2020) apply to the App and Template Marketplaces?

No, the most recent European Union P2B regulation that took effect on July 12, 2020, does not apply to the HubSpot App and Template Marketplaces. [Learn More](https://ec.europa.eu/digital-single-market/en/business-business-trading-practices).

Is there a specific HubSpot account type I need to submit to the Marketplace?

A [Marketplace provider account](https://offers.hubspot.com/free-marketplace-account) is needed to submit to the Template Marketplace.
...
Customers who have purchased previous versions of a product in a listing can [update to the latest version](https://knowledge.hubspot.com/articles/kcs_article/resources/marketplace-customers-frequently-asked-questions#update) free of charge.
...
When creating preview URLs you must use your own domain name if available. If you don't have a domain available to use, HubSpot provides each account with a system domain in the following URL structure:  
...
Join the #marketplace channel in HubSpot's Developer Slack by signing up at  [https://developers.hubspot.com/slack](https://developers.hubspot.com/slack).
...
To stay informed of the latest changes, visit and subscribe to the [HubSpot Developer Changelog](/changelog). 

* * *

Share your feedback[](https://developers.hubspot.com/docs/cms/marketplace-guidelines#page-feedback)
---------------------------------------------------------------------------------------------------

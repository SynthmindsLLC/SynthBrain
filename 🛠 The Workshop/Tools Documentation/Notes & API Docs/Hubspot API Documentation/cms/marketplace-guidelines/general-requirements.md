...
HubSpot reserves the right to change the information on your template listing submission to comply with the following requirements. Read more about [best practices for listing a theme or module on the HubSpot Template Marketplace](/blog/best-practices-for-listing-your-theme-or-module-on-hubspots-asset-marketplace). 

List a template on the HubSpot Template Marketplace[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/general-requirements#list-a-template-on-the-hubspot-template-marketplace)
----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
![listing-info](https://developers.hubspot.com/hubfs/Knowledge_Base_2023_2024/listing-info.png "listing-info")

### Listing Info[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/general-requirements#listing-info)
...
![storefront-example](https://developers.hubspot.com/hubfs/Knowledge_Base_2023_2024/storefront-example.png "storefront-example")

![storefront-example-2](https://developers.hubspot.com/hubfs/Knowledge_Base_2023_2024/storefront-example-2.png "storefront-example-2")

Examples of good module thumbnail images:

![module-thumbnail-1](https://developers.hubspot.com/hubfs/Knowledge_Base_2023_2024/module-thumbnail-1.png "module-thumbnail-1")

![module-thumbnail-3](https://developers.hubspot.com/hubfs/Knowledge_Base_2023_2024/module-thumbnail-3.png "module-thumbnail-3")

### Theme/Module Details[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/general-requirements#theme-module-details)
...
![content-tab](https://developers.hubspot.com/hubfs/Knowledge_Base_2023_2024/content-tab.png "content-tab")

![styles-tab](https://developers.hubspot.com/hubfs/Knowledge_Base_2023_2024/styles-tab.png "styles-tab")

*   The page-level editor settings of the module. If [repeater content](/docs/cms/building-blocks/module-theme-fields-overview#repeaters) is used in the module, you must provide a screenshot of one instance of the repeating item settings.

![repeater-content](https://developers.hubspot.com/hubfs/Knowledge_Base_2023_2024/repeater-content.png "repeater-content")

### Category[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/general-requirements#category)
...
### Support[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/general-requirements#support)
...
### Review[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/general-requirements#review)
...
Templates **must not** include images from the [HubSpot-Shutterstock integration](https://knowledge.hubspot.com/files/how-can-i-use-stock-images-in-my-content-with-the-shutterstock-integration).
...
Share your feedback[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/general-requirements#page-feedback)
------------------------------------------------------------------------------------------------------------------------

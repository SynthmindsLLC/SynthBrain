...
description: "Provides an overview of the event analytics API for CRM records in HubSpot, including how to fetch events associated with various types and customize queries by object ID or property."
type: "concept"
tags:
- "Event Analytics"
- "CRM Records"

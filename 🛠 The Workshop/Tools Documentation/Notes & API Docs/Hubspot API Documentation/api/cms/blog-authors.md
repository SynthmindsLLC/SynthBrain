...
Changes in V3[](https://developers.hubspot.com/docs/api/cms/blog-authors#changes-in-v3)
---------------------------------------------------------------------------------------
...
Search blog authors[](https://developers.hubspot.com/docs/api/cms/blog-authors#search-blog-authors)
---------------------------------------------------------------------------------------------------
...
### Filtering[](https://developers.hubspot.com/docs/api/cms/blog-authors#filtering)

Provide any filters as query parameters in your request, by adding the property name, followed by two underscore characters, then include the associated operator as a suffix. For example, you can filter the results to only include authors where the `displayName` property contains the word _J__ohn_ using the parameter: `&displayName__icontains=john`.
...
Primary blog author in a multi-language group.
...
Variation blog author in a multi-language group.
...
Blog author with a specific language.

 |

### Sorting and paginating[](https://developers.hubspot.com/docs/api/cms/blog-authors#sorting-and-paginating)
...
curl https://api.hubapi.com/cms/v3/blogs/authors?sort=-updatedAt&&language\_\_not\_null&limit=10&offset=10 \\ --request POST \\ --header "Content-Type: application/json"

Create blog authors[](https://developers.hubspot.com/docs/api/cms/blog-authors#create-blog-authors)
---------------------------------------------------------------------------------------------------
...
Edit blog authors[](https://developers.hubspot.com/docs/api/cms/blog-authors#edit-blog-authors)
-----------------------------------------------------------------------------------------------
...
Multi-language management[](https://developers.hubspot.com/docs/api/cms/blog-authors#multi-language-management)
---------------------------------------------------------------------------------------------------------------
...
### Create a new language variant[](https://developers.hubspot.com/docs/api/cms/blog-authors#create-a-new-language-variant)
...
### Attach a blog author to an existing multi-language group[](https://developers.hubspot.com/docs/api/cms/blog-authors#attach-a-blog-author-to-an-existing-multi-language-group)
...
### Detach a blog author from a multi-language group[](https://developers.hubspot.com/docs/api/cms/blog-authors#detach-a-blog-author-from-a-multi-language-group)
...
Share your feedback[](https://developers.hubspot.com/docs/api/cms/blog-authors#page-feedback)
---------------------------------------------------------------------------------------------

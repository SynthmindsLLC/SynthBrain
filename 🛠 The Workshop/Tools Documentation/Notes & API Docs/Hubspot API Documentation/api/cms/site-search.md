...
**Example use case:** Set up a results page to use a search field on your HubSpot-hosted site. See [knowledge article](https://knowledge.hubspot.com/cos-general/how-do-i-set-up-a-results-page-for-my-search-field-in-hubspot?_ga=2.11633971.64031446.1580737171-1635676776.1568129882) for more information.

**Note**: The search endpoint is used to search content across multiple domains. 

* * *

Share your feedback[](https://developers.hubspot.com/docs/api/cms/site-search#page-feedback)
--------------------------------------------------------------------------------------------

...
description: "The fourth version of the CRM associations API, which represents relationships between objects and activities in HubSpot CRM. It allows for creating, retrieving, updating, or deleting associations between records or records and activities. Custom association types can be created by account admins to provide additional context for record relationships."
type: "group"
tags:
- "CRM"
- "Associations_API"

...
description: "A type of integration that can be installed on customer accounts or listed on the App Marketplace, requiring OAuth authentication for API calls and webhooks."
type: "group"
tags:
- "HubSpot"
- "Integration"

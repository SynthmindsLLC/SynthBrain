[![](https://img.realpython.net/1c3e33fa8ce0d82a964b7f7de310e4bb)](https://srv.realpython.net/click/21871400699/?c=41831496980&p=29182759436&r=99143)

Structuring Your Project[¶](#structuring-your-project "Permalink to this headline")
===================================================================================

![https://d33wubrfki0l68.cloudfront.net/bbfe9839e1e09a4a9d9cb955d0d547a8bc21e440/ba0a9/_images/33907151224_0574e7dfc2_k_d.jpg](https://d33wubrfki0l68.cloudfront.net/bbfe9839e1e09a4a9d9cb955d0d547a8bc21e440/ba0a9/_images/33907151224_0574e7dfc2_k_d.jpg)
...
Structure of the Repository[¶](#structure-of-the-repository "Permalink to this headline")
-----------------------------------------------------------------------------------------

### It’s Important.[¶](#it-s-important "Permalink to this headline")
...
### Sample Repository[¶](#sample-repository "Permalink to this headline")
...
### The Actual Module[¶](#the-actual-module "Permalink to this headline")

<table border="1" class="colwidths-given docutils"><colgroup><col width="33%"> <col width="67%"></colgroup><tbody valign="top"><tr class="row-odd"><td>Location</td><td><code class="docutils literal notranslate"><span class="pre">./sample/</span></code> or <code class="docutils literal notranslate"><span class="pre">./sample.py</span></code></td></tr><tr class="row-even"><td>Purpose</td><td>The code of interest</td></tr></tbody></table>
...
<table border="1" class="colwidths-given docutils"><colgroup><col width="33%"> <col width="67%"></colgroup><tbody valign="top"><tr class="row-odd"><td>Location</td><td><code class="docutils literal notranslate"><span class="pre">./LICENSE</span></code></td></tr><tr class="row-even"><td>Purpose</td><td>Lawyering up.</td></tr></tbody></table>
...
### Setup.py[¶](#setup-py "Permalink to this headline")

<table border="1" class="colwidths-given docutils"><colgroup><col width="33%"> <col width="67%"></colgroup><tbody valign="top"><tr class="row-odd"><td>Location</td><td><code class="docutils literal notranslate"><span class="pre">./setup.py</span></code></td></tr><tr class="row-even"><td>Purpose</td><td>Package and distribution management.</td></tr></tbody></table>

If your module package is at the root of your repository, this should obviously be at the root as well.

### Requirements File[¶](#requirements-file "Permalink to this headline")

<table border="1" class="colwidths-given docutils"><colgroup><col width="33%"> <col width="67%"></colgroup><tbody valign="top"><tr class="row-odd"><td>Location</td><td><code class="docutils literal notranslate"><span class="pre">./requirements.txt</span></code></td></tr><tr class="row-even"><td>Purpose</td><td>Development dependencies.</td></tr></tbody></table>
...
<table border="1" class="colwidths-given docutils"><colgroup><col width="33%"> <col width="67%"></colgroup><tbody valign="top"><tr class="row-odd"><td>Location</td><td><code class="docutils literal notranslate"><span class="pre">./docs/</span></code></td></tr><tr class="row-even"><td>Purpose</td><td>Package reference documentation.</td></tr></tbody></table>

There is little reason for this to exist elsewhere.

### Test Suite[¶](#test-suite "Permalink to this headline")

_For advice on writing your tests, see_ [Testing Your Code](../tests/).

<table border="1" class="colwidths-given docutils"><colgroup><col width="33%"> <col width="67%"></colgroup><tbody valign="top"><tr class="row-odd"><td>Location</td><td><code class="docutils literal notranslate"><span class="pre">./test_sample.py</span></code> or <code class="docutils literal notranslate"><span class="pre">./tests</span></code></td></tr><tr class="row-even"><td>Purpose</td><td>Package integration and unit tests.</td></tr></tbody></table>
...
*   Use a simple (but _explicit_) path modification to resolve the package properly.
...
### Makefile[¶](#makefile "Permalink to this headline")

<table border="1" class="colwidths-given docutils"><colgroup><col width="33%"> <col width="67%"></colgroup><tbody valign="top"><tr class="row-odd"><td>Location</td><td><code class="docutils literal notranslate"><span class="pre">./Makefile</span></code></td></tr><tr class="row-even"><td>Purpose</td><td>Generic management tasks.</td></tr></tbody></table>
...
### Regarding Django Applications[¶](#regarding-django-applications "Permalink to this headline")
...
Structure of Code is Key[¶](#structure-of-code-is-key "Permalink to this headline")
-----------------------------------------------------------------------------------
...
Object-oriented programming[¶](#object-oriented-programming "Permalink to this headline")
-----------------------------------------------------------------------------------------
...
Decorators[¶](#decorators "Permalink to this headline")
-------------------------------------------------------
...
Context Managers[¶](#context-managers "Permalink to this headline")
-------------------------------------------------------------------
...
Dynamic typing[¶](#dynamic-typing "Permalink to this headline")
---------------------------------------------------------------
...
Mutable and immutable types[¶](#mutable-and-immutable-types "Permalink to this headline")
-----------------------------------------------------------------------------------------
...
my\_list \= \[1, 2, 3\]
my\_list\[0\] \= 4
print(my\_list)  \# \[4, 2, 3\] <- The same list has changed
...
Vendorizing Dependencies[¶](#vendorizing-dependencies "Permalink to this headline")
-----------------------------------------------------------------------------------

Runners[¶](#runners "Permalink to this headline")
-------------------------------------------------

Further Reading[¶](#further-reading "Permalink to this headline")
-----------------------------------------------------------------

*   [http://docs.python.org/3/library/](http://docs.python.org/3/library/)

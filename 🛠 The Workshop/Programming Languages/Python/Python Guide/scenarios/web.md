[![](https://img.realpython.net/6fe6464c8bf6ec2cbcf3f1f0e778156b)](https://srv.realpython.net/click/57356986228/?c=41067926597&p=29182759436&r=96656)

Web Applications & Frameworks[¶](#web-applications-frameworks "Permalink to this headline")
===========================================================================================

![https://d33wubrfki0l68.cloudfront.net/bcd3c74654315a9e38a62ed3c32042906ad7bd4b/c2a91/_images/34309496175_b82d104282_k_d.jpg](https://d33wubrfki0l68.cloudfront.net/bcd3c74654315a9e38a62ed3c32042906ad7bd4b/c2a91/_images/34309496175_b82d104282_k_d.jpg)
...
### WSGI[¶](#wsgi "Permalink to this headline")

The Web Server Gateway Interface (or “WSGI” for short) is a standard interface between web servers and Python web application frameworks. By standardizing behavior and communication between web servers and Python web frameworks, WSGI makes it possible to write portable Python web code that can be deployed in any [WSGI-compliant web server](#wsgi-servers-ref). WSGI is documented in [**PEP 3333**](https://www.python.org/dev/peps/pep-3333).

Frameworks[¶](#frameworks "Permalink to this headline")
-------------------------------------------------------
...
### Flask[¶](#flask "Permalink to this headline")
...
### Falcon[¶](#falcon "Permalink to this headline")
...
### Tornado[¶](#tornado "Permalink to this headline")
...
### Pyramid[¶](#pyramid "Permalink to this headline")
...
### Masonite[¶](#masonite "Permalink to this headline")
...
### FastAPI[¶](#fastapi "Permalink to this headline")
...
Web Servers[¶](#web-servers "Permalink to this headline")
---------------------------------------------------------

### Nginx[¶](#nginx "Permalink to this headline")
...
WSGI Servers[¶](#wsgi-servers "Permalink to this headline")
-----------------------------------------------------------

Stand-alone WSGI servers typically use less resources than traditional web servers and provide top performance [\[1\]](#id17).

### Gunicorn[¶](#gunicorn "Permalink to this headline")
...
### Waitress[¶](#waitress "Permalink to this headline")
...
### uWSGI[¶](#uwsgi "Permalink to this headline")
...
Server Best Practices[¶](#server-best-practices "Permalink to this headline")
-----------------------------------------------------------------------------
...
Hosting[¶](#hosting "Permalink to this headline")
-------------------------------------------------
...
### Heroku[¶](#heroku "Permalink to this headline")
...
Templating[¶](#templating "Permalink to this headline")
-------------------------------------------------------
...
### Jinja2[¶](#jinja2 "Permalink to this headline")
...
TEMPLATE\_FILE \= "site.html"
templateLoader \= FileSystemLoader( searchpath\="templates/" )
templateEnv \= Environment( loader\=templateLoader )
template \= templateEnv.get\_template(TEMPLATE\_FILE)

\# List for famous movie rendering
movie\_list \= \[\[1,"The Hitchhiker's Guide to the Galaxy"\],\[2,"Back to future"\],\[3,"Matrix"\]\]

\# template.render() returns a string which contains the rendered html
html\_output \= template.render(list\=movie\_list,
...
### Chameleon[¶](#chameleon "Permalink to this headline")
...
### Mako[¶](#mako "Permalink to this headline")
...
<table class="docutils footnote" frame="void" id="id17" rules="none"><colgroup><col class="label"><col></colgroup><tbody valign="top"><tr><td class="label"><a class="fn-backref" href="#id9">[1]</a></td><td><a class="reference external" href="http://nichol.as/benchmark-of-python-web-servers">Benchmark of Python WSGI Servers</a></td></tr></tbody></table>
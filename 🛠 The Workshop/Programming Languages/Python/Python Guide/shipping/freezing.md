[![](https://img.realpython.net/8899c4a6d15334a6b9f769e9f8bc0cf7)](https://srv.realpython.net/click/41686012779/?c=7309556696&p=29182759436&r=07285)

Freezing Your Code[¶](#freezing-your-code "Permalink to this headline")
=======================================================================

![https://d33wubrfki0l68.cloudfront.net/39155010c31c8d7a71555a776792afffc74430bf/46336/_images/33907151034_e0a9e53402_k_d.jpg](https://d33wubrfki0l68.cloudfront.net/39155010c31c8d7a71555a776792afffc74430bf/46336/_images/33907151034_e0a9e53402_k_d.jpg)
...
Alternatives to Freezing[¶](#alternatives-to-freezing "Permalink to this headline")
-----------------------------------------------------------------------------------

[Packaging your code](../packaging/#packaging-your-code-ref) is for distributing libraries or tools to other developers.

On Linux, an alternative to freezing is to [create a Linux distro package](../packaging/#packaging-for-linux-distributions-ref) (e.g. .deb files for Debian or Ubuntu, or .rpm files for Red Hat and SuSE.)

Todo

Fill in “Freezing Your Code” stub

Comparison of Freezing Tools[¶](#comparison-of-freezing-tools "Permalink to this headline")
-------------------------------------------------------------------------------------------

Date of this writing: Oct 5, 2019 Solutions and platforms/features supported:

          
| Solution | Windows | Linux | OS X | Python 3 | License | One-file mode | Zipfile import | Eggs | pkg\_resources support | Latest release date |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| cx\_Freeze | yes | yes | yes | yes | PSF | no | yes | yes | no | Aug 29, 2019 |
...
### bbFreeze[¶](#bbfreeze "Permalink to this headline")

Prerequisite is to install [Python, Setuptools and pywin32 dependency on Windows](../../starting/install/win/#install-windows).
...
freezer.addScript('foobar.py', gui\_only\=True)
freezer()
...
freezer \= Freezer(distdir\='dist', includes\=\['my\_code'\], excludes\=\['docs'\])

3.  (Optionally) include icon

freezer.setIcon('my\_awesome\_icon.ico')
...
### py2exe[¶](#py2exe "Permalink to this headline")

Prerequisite is to install [Python on Windows](../../starting/install/win/#install-windows). The last release of py2exe is from the year 2014. There is not active development.

1.  Download and install [http://sourceforge.net/projects/py2exe/files/py2exe/](http://sourceforge.net/projects/py2exe/files/py2exe/)
...
### PyInstaller[¶](#pyinstaller "Permalink to this headline")

Prerequisite is to have installed [Python, Setuptools and pywin32 dependency on Windows](../../starting/install/win/#install-windows).
...
### py2app[¶](#py2app "Permalink to this headline")

### PyInstaller[¶](#id1 "Permalink to this headline")
...
### bbFreeze[¶](#id2 "Permalink to this headline")
...
bbFreeze can be used with all distributions that has Python installed along with pip2 and/or easy\_install.
...
freezer \= Freezer(distdir\='dist')
freezer.addScript('script.py', gui\_only\=True) \# Enable gui\_only kwarg for app that uses GUI packages.
freezer()

### PyInstaller[¶](#id4 "Permalink to this headline")

[![](https://img.realpython.net/8899c4a6d15334a6b9f769e9f8bc0cf7)](https://srv.realpython.net/click/41686012779/?c=7309556696&p=29182759436&r=76876)

Pipenv & Virtual Environments[¶](#pipenv-virtual-environments "Permalink to this headline")
===========================================================================================

![https://d33wubrfki0l68.cloudfront.net/65ceaa545321e4361a74c32f66474929014b44b4/68792/_images/35294660055_42c02b2316_k_d.jpg](https://d33wubrfki0l68.cloudfront.net/65ceaa545321e4361a74c32f66474929014b44b4/68792/_images/35294660055_42c02b2316_k_d.jpg)
...
Make sure you’ve got Python & pip[¶](#make-sure-you-ve-got-python-pip "Permalink to this headline")
---------------------------------------------------------------------------------------------------
...
Installing Pipenv[¶](#installing-pipenv "Permalink to this headline")
---------------------------------------------------------------------
...
Installing packages for your project[¶](#installing-packages-for-your-project "Permalink to this headline")
-----------------------------------------------------------------------------------------------------------
...
Using installed packages[¶](#using-installed-packages "Permalink to this headline")
-----------------------------------------------------------------------------------
...
Lower level: virtualenv[¶](#lower-level-virtualenv "Permalink to this headline")
================================================================================
...
$ export VIRTUALENVWRAPPER\_PYTHON\=/usr/bin/python2.7
...
C:\\Users\\SomeUser\\project\_folder> venv\\Scripts\\activate
...
Other Notes[¶](#other-notes "Permalink to this headline")
---------------------------------------------------------
...
Lastly, remember to exclude the virtual environment folder from source control by adding it to the ignore list (see [Version Control Ignores](../../writing/gotchas/#version-control-ignores)).

virtualenvwrapper[¶](#virtualenvwrapper "Permalink to this headline")
---------------------------------------------------------------------
...
### Basic Usage[¶](#id2 "Permalink to this headline")

1.  Create a virtual environment:

$ mkvirtualenv project\_folder

This creates the `project_folder` folder inside `~/Envs`.

2.  Work on a virtual environment:

$ workon project\_folder
...
### Other useful commands[¶](#other-useful-commands "Permalink to this headline")
...
virtualenv-burrito[¶](#virtualenv-burrito "Permalink to this headline")
-----------------------------------------------------------------------
...
direnv[¶](#direnv "Permalink to this headline")
-----------------------------------------------

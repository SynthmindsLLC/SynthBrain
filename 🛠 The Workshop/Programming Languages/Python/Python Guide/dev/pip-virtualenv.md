[![](https://img.realpython.net/8899c4a6d15334a6b9f769e9f8bc0cf7)](https://srv.realpython.net/click/41686012779/?c=7309556696&p=29182759436&r=47877)

Further Configuration of pip and Virtualenv[¶](#further-configuration-of-pip-and-virtualenv "Permalink to this headline")
=========================================================================================================================

![https://d33wubrfki0l68.cloudfront.net/740dd32b37daec5f4d9d475ed3598ebeec4d39b1/a911a/_images/34018732105_f0e6758859_k_d.jpg](https://d33wubrfki0l68.cloudfront.net/740dd32b37daec5f4d9d475ed3598ebeec4d39b1/a911a/_images/34018732105_f0e6758859_k_d.jpg)

Requiring an active virtual environment for `pip`[¶](#requiring-an-active-virtual-environment-for-pip "Permalink to this headline")
-----------------------------------------------------------------------------------------------------------------------------------
...
export PIP\_REQUIRE\_VIRTUALENV=true
...
gpip() {
    PIP\_REQUIRE\_VIRTUALENV=false pip "$@"
}
...
Caching packages for future use[¶](#caching-packages-for-future-use "Permalink to this headline")
-------------------------------------------------------------------------------------------------
...
export PIP\_DOWNLOAD\_CACHE=$HOME/.pip/cache
...
Even though you can use any path you like to store your cache, it is recommended that you create a new folder _in_ the folder where your `pip.conf` or `pip.ini` file lives. If you don’t trust yourself with all of this path voodoo, just use the values provided here and you will be fine.
13\. Enumerate[¶](#enumerate "Permalink to this headline")
==========================================================
...
my\_list \= \['apple', 'banana', 'grapes', 'pear'\]
for counter, value in enumerate(my\_list):
    print counter, value
...
my\_list \= \['apple', 'banana', 'grapes', 'pear'\]
for c, value in enumerate(my\_list, 1):
    print(c, value)
...
my\_list \= \['apple', 'banana', 'grapes', 'pear'\]
counter\_list \= list(enumerate(my\_list, 1))
print(counter\_list)

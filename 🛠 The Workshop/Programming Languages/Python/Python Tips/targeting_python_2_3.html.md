24\. Targeting Python 2+3[¶](#targeting-python-2-3 "Permalink to this headline")
================================================================================
...
try:
    import urllib.request as urllib\_request  \# for Python 3
except ImportError:
    import urllib2 as urllib\_request  \# for Python 2
...
For further reading, the Python documentation has a [comprehensive guide](https://docs.python.org/3/howto/pyporting.html) of steps you need to take to make your code compatible with both Python 2 and 3.
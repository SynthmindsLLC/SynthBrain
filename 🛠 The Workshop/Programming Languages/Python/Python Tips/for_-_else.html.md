21\. `for/else`[¶](#for-else "Permalink to this headline")
==========================================================
...
21.1. `else` Clause[¶](#else-clause "Permalink to this headline")
-----------------------------------------------------------------
...
for item in container:
    if search\_something(item):
        \# Found it!
        process(item)
        break
else:
    \# Didn't find anything..
    not\_found\_in\_container()

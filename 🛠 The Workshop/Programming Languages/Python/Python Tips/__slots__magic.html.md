10\. \_\_slots\_\_ Magic[¶](#slots-magic "Permalink to this headline")
======================================================================
...
class MyClass(object):
    def \_\_init\_\_(self, name, identifier):
        self.name \= name
...
Below you can see an example showing exact memory usage with and without `__slots__` done in IPython thanks to [https://github.com/ianozsvald/ipython\_memory\_usage](https://github.com/ianozsvald/ipython_memory_usage)
...
In \[1\]: import ipython\_memory\_usage.ipython\_memory\_usage as imu

In \[2\]: imu.start\_watching\_memory()

3\. Generators[¶](#generators "Permalink to this headline")
===========================================================
...
3.1. Iterable[¶](#iterable "Permalink to this headline")
--------------------------------------------------------

An `iterable` is any object in Python which has an `__iter__` or a `__getitem__` method defined which returns an **iterator** or can take indexes (You can read more about them [here](https://stackoverflow.com/a/20551346)). In short an `iterable` is any object which can provide us with an **iterator**. So what is an **iterator**?

3.2. Iterator[¶](#iterator "Permalink to this headline")
--------------------------------------------------------
...
3.3. Iteration[¶](#iteration "Permalink to this headline")
----------------------------------------------------------
...
3.4. Generators[¶](#id1 "Permalink to this headline")
-----------------------------------------------------
...
for item in generator\_function():
    print(item)

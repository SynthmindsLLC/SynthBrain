11\. Virtual Environment[¶](#virtual-environment "Permalink to this headline")
==============================================================================
...
This was just a short intro to virtualenv. There’s a lot more to it; [this link](http://docs.python-guide.org/en/latest/dev/virtualenvs/) has more information.
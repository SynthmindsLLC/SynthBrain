23\. `open` Function[¶](#open-function "Permalink to this headline")
====================================================================
...
The first argument of `open` is the filename. The second one (the _mode_) determines _how_ the file gets opened.

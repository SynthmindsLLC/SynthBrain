17\. Exceptions[¶](#exceptions "Permalink to this headline")
============================================================
...
17.1. Handling multiple exceptions:[¶](#handling-multiple-exceptions "Permalink to this headline")
--------------------------------------------------------------------------------------------------
...
### 17.1.1. `finally` clause[¶](#finally-clause "Permalink to this headline")
...
### 17.1.2. `try/else` clause[¶](#try-else-clause "Permalink to this headline")

6\. Ternary Operators[¶](#ternary-operators "Permalink to this headline")
=========================================================================
...
is\_nice \= True
state \= "nice" if is\_nice else "not nice"
...
\>>> def my\_function(real\_name, optional\_display\_name\=None):
\>>>     optional\_display\_name \= optional\_display\_name or real\_name
\>>>     print(optional\_display\_name)
\>>> my\_function("John")
John
\>>> my\_function("Mike", "anonymous123")
anonymous123
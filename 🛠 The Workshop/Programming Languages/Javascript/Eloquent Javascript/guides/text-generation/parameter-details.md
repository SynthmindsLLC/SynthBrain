...
](/playground?mode=chat&model=gpt-4o)[
...
To mimic the effect seen in ChatGPT where the text is returned iteratively, set the [stream](/docs/api-reference/chat/create#chat/create-stream) parameter to true.

[

### Chat Completions response format

](/docs/guides/text-generation/chat-completions-response-format)
...
](/docs/guides/text-generation/json-mode)

A common way to use Chat Completions is to instruct the model to always return a JSON object that makes sense for your use case, by specifying this in the system message. While this does work in some cases, occasionally the models may generate output that does not parse to valid JSON objects.

To prevent these errors and improve model performance, when using `gpt-4o`, `gpt-4-turbo`, or `gpt-3.5-turbo`, you can set [response\_format](/docs/api-reference/chat/create#chat-create-response_format) to `{ "type": "json_object" }` to enable JSON mode. When JSON mode is enabled, the model is constrained to only generate strings that parse into valid JSON object.
...
](/docs/guides/text-generation/reproducible-outputs)
...
](/docs/guides/text-generation/managing-tokens)
...
](/docs/guides/text-generation/frequency-and-presence-penalties)
...
](/docs/guides/text-generation/token-log-probabilities)
...
](/docs/guides/text-generation/completions-api)
...
](/docs/guides/text-generation/inserting-text)
...
](/docs/guides/text-generation/completions-response-format)
...
](/docs/guides/text-generation/chat-completions-vs-completions)
...
](/docs/guides/text-generation/prompt-engineering)
...
](/docs/guides/text-generation/faq)

[

### Which model should I use?

](/docs/guides/text-generation/which-model-should-i-use)
...
](/docs/guides/text-generation/how-should-i-set-the-temperature-parameter)
...
](/docs/guides/text-generation/is-fine-tuning-available-for-the-latest-models)
...
](/docs/guides/text-generation/do-you-store-the-data-that-is-passed-into-the-api)
...
](/docs/guides/text-generation/how-can-i-make-my-application-more-safe)
...
](/docs/guides/text-generation/should-i-use-chatgpt-or-the-api)

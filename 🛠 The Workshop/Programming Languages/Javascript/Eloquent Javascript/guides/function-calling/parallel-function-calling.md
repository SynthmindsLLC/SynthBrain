...
](/docs/guides/function-calling/function-calling)
...
](/docs/guides/function-calling/introduction)
...
This guide is focused on function calling with the Chat Completions API, for details on function calling in the Assistants API, please see the [Assistants Tools page](/docs/assistants/tools/function-calling).

[

### Common use cases

](/docs/guides/function-calling/common-use-cases)
...
](/docs/guides/function-calling/supported-models)
...
](/docs/guides/function-calling/function-calling-behavior)
...
](/docs/guides/function-calling/parallel-function-calling)
...
](/docs/guides/function-calling/tokens)

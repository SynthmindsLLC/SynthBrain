...
](/docs/guides/fine-tuning/fine-tuning)
...
](/docs/guides/fine-tuning/introduction)
...
](/docs/guides/fine-tuning/which-models-can-be-fine-tuned)

Fine-tuning for GPT-4 (\`gpt-4-0613\` and \`gpt-4o-\*\`) is in an experimental access program - eligible users can request access in the [fine-tuning UI](/finetune) when creating a new fine-tuning job.
...
](/docs/guides/fine-tuning/when-to-use-fine-tuning)
...
](/docs/guides/fine-tuning/example-format)
...
](/docs/guides/fine-tuning/multi-turn-chat-examples)
...
](/docs/guides/fine-tuning/crafting-prompts)
...
](/docs/guides/fine-tuning/example-count-recommendations)
...
](/docs/guides/fine-tuning/train-and-test-splits)
...
](/docs/guides/fine-tuning/token-limits)
...
](/docs/guides/fine-tuning/estimate-costs)
...
](/docs/guides/fine-tuning/check-data-formatting)
...
](/docs/guides/fine-tuning/upload-a-training-file)
...
](/docs/guides/fine-tuning/create-a-fine-tuned-model)
...
](/docs/guides/fine-tuning/use-a-fine-tuned-model)
...
](/docs/guides/fine-tuning/use-a-checkpointed-model)
...
](/docs/guides/fine-tuning/iterating-on-data-quality)
...
](/docs/guides/fine-tuning/iterating-on-data-quantity)
...
](/docs/guides/fine-tuning/iterating-on-hyperparameters)
...
](/docs/guides/fine-tuning/fine-tuning-examples)
...
](/docs/guides/fine-tuning/fine-tuning-integrations)
...
](/docs/guides/fine-tuning/weights-and-biases-integration)
...
](/docs/guides/fine-tuning/authenticate-your-weights-and-biases-account-with-openai)
...
](/docs/guides/fine-tuning/enable-the-weights-and-biases-integration)
...
](/docs/guides/fine-tuning/view-your-fine-tuning-job-in-weights-and-biases)
...
*   `openai/ft-abc123`: The ID of the fine-tuning job openai/gpt-3.5-turbo-0125\`: The model you are fine-tuning
...
](/docs/guides/fine-tuning/faq)

[

### When should I use fine-tuning vs embeddings / retrieval augmented generation?

](/docs/guides/fine-tuning/when-should-i-use-fine-tuning-vs-embeddings-retrieval-augmented-generation)
...
](/docs/guides/fine-tuning/can-i-fine-tune-gpt-4o-gpt-4-turbo-or-gpt-4)
...
](/docs/guides/fine-tuning/how-do-i-know-if-my-fine-tuned-model-is-actually-better-than-the-base-model)
...
](/docs/guides/fine-tuning/can-i-continue-fine-tuning-a-model-that-has-already-been-fine-tuned)
...
](/docs/guides/fine-tuning/how-can-i-estimate-the-cost-of-fine-tuning-a-model)
...
](/docs/guides/fine-tuning/how-many-fine-tuning-jobs-can-i-have-running-at-once)
...
](/docs/guides/fine-tuning/how-do-rate-limits-work-on-fine-tuned-models)
...
](/docs/guides/fine-tuning/can-i-use-the-v1-fine-tunes-endpoint)

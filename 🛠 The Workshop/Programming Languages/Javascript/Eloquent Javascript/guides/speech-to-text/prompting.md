...
](/docs/guides/speech-to-text/speech-to-text)
...
](/docs/guides/speech-to-text/introduction)
...
](/docs/guides/speech-to-text/quickstart)

[

### Transcriptions

](/docs/guides/speech-to-text/transcriptions)
...
](/docs/guides/speech-to-text/translations)
...
](/docs/guides/speech-to-text/supported-languages)
...
](/docs/guides/speech-to-text/timestamps)
...
](/docs/guides/speech-to-text/longer-inputs)
...
](/docs/guides/speech-to-text/prompting)
...
](/docs/guides/speech-to-text/improving-reliability)

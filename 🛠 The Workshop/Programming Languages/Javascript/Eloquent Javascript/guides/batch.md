...
](/docs/guides/batch/getting-started)

[

### 1\. Preparing Your Batch File

](/docs/guides/batch/1-preparing-your-batch-file)
...
](/docs/guides/batch/2-uploading-your-batch-input-file)
...
](/docs/guides/batch/3-creating-the-batch)
...
](/docs/guides/batch/4-checking-the-status-of-a-batch)
...
](/docs/guides/batch/5-retrieving-the-results)
...
](/docs/guides/batch/6-cancelling-a-batch)
...
](/docs/guides/batch/7-getting-a-list-of-all-batches)
...
](/docs/guides/batch/model-availability)
...
](/docs/guides/batch/batch-expiration)
...
](/docs/guides/batch/other-resources)

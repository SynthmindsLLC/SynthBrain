...
> ------------------------------------
> 
> Refer to the [status codes documentation](/reference/status-codes) for an up-to-date list of error codes.
...
| 400 | `"missing_version"` | The request is missing the required `Notion-Version` header. See [Versioning](/reference/versioning). |
...
| 429 | `"rate_limited"` | This request exceeds the number of requests allowed. Slow down and try again. [More details on rate limits](/reference/request-limits). |

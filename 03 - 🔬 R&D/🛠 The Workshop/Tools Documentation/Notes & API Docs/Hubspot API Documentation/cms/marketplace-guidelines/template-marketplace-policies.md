...
*   [Theme](/docs/cms/marketplace-guidelines/theme-requirements) and [module](/docs/cms/marketplace-guidelines/module-requirements) technical requirements
*   Theme and module [listing page requirements](/docs/cms/marketplace-guidelines/general-requirements)
...
Compliance with Template Marketplace Policies[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#compliance-with-template-marketplace-policies)
-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

You agree to comply with the terms and conditions of the [Marketplace Terms of Use](https://legal.hubspot.com/marketplace-tou), [Developer Terms](https://legal.hubspot.com/developer-terms) and [Developer Policy](https://legal.hubspot.com/hubspot-developer-policy), the Template Marketplace Policies, [Template Marketplace Guidelines](/docs/cms/marketplace-guidelines), and the Template Branding Guidelines at all times, which are incorporated herein by reference. The Template Marketplace Policies and Template Marketplace Guidelines may include requirements that you must complete in order to be listed in the Template Marketplace. 
...
Template Marketplace compliance[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#template-marketplace-compliance)
---------------------------------------------------------------------------------------------------------------------------------------------------------------

### Acceptable Template Marketplace submissions[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#acceptable-template-marketplace-submissions)

You can submit only themes and modules to the Template Marketplace.

#### Free template limits[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#free-template-limits)
...
### Marketplace provider information[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#marketplace-provider-information)
...
### Template ownership[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#template-ownership)
...
### Template variants as separate submissions are not permitted[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#template-variants-as-separate-submissions-are-not-permitted)

Examples of unacceptable variations include, but are not limited to:
...
Design and code requirements[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#design-and-code-requirements)
---------------------------------------------------------------------------------------------------------------------------------------------------------

The following requirements must be adhered to when designing templates for the HubSpot Template Marketplace. 

### Mobile/desktop resolution and browsers[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#mobile-desktop-resolution-and-browsers)
...
### Design aesthetics[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#design-aesthetics)
...
### Stylesheets and scripts[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#stylesheets-and-scripts)

When including stylesheets or JavaScript files in your themes and modules, it's recommended to:

*   Use the [require\_css function](https://developers.hubspot.com/docs/cms/hubl/functions#require-css) and [require\_js function](https://developers.hubspot.com/docs/cms/hubl/functions#require-js) to include these files.
*   Load render-blocking JavaScript in the footer to improve performance.

When including style sheets or JavaScript files in a theme's module, it is strongly recommend to [link these file dependencies](/docs/cms/building-blocks/modules/configuration#adding-css-and-javascript-dependencies) to the module. 

Learn more about [module code quality requirements](https://developers.hubspot.com/docs/cms/marketplace-guidelines/module-requirements#module-code-quality). 

### Classes[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#classes)

#### ID and class naming conventions[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#id-and-class-naming-conventions)
...
#### Default classes[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#default-classes)
...
/\* ids \*/ #hs\_cos\_wrapper\*, #hs\_form\_target\_dnd\* /\* classes \*/ .heading-container-wrapper, .heading-container, .body-container-wrapper, .body-container, .footer-container-wrapper, .footer-container, .container-fluid, .row-fluid, .row-fluid-wrapper, .row-depth-\*, .row-number-\*, .span\*, .hs-cos-wrapper, .hs-cos-wrapper-widget, .dnd-section, .dnd-column, .dnd-row, .dnd-module, .dnd\_area\*
...
#### Adding classes inside the rich text editor source code[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#adding-classes-inside-the-rich-text-editor-source-code)
...
### Redundant and unnecessary code[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#redundant-and-unnecessary-code)
...
There is a difference between commented out code and comments in code. If you are providing context in your code for clarification purposes, use the [comment delimiter](/docs/cms/hubl#types-of-delimiters) as this will let you comment on your code while also not having these comments show in the “View Source” or “Inspect” views of a page. See below for an example.

<p>This is a sample. When viewing source, you should only see the HTML Comment.</p> <p>HTML Comment Wrapper Start</p> <!-- This is an HTML Comment and will show in the View Source / Inspect --> <p>HTML Comment Wrapper End</p> <hr> <p>HubL Delimiter Comment Wrapper Start</p> {# This comment is using the HubL Delimiter for comments. These comments appear here but do not render in the front end #} <p>HubL Delimiter Comment Wrapper End</p>

### Templates must load over HTTPS[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#templates-must-load-over-https)
...
### Third-party files[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#third-party-files)
...
**Please note:** if you are including files in a module, you must use the [css\_assets](https://developers.hubspot.com/docs/cms/building-blocks/modules/configuration) and [js\_assets](https://developers.hubspot.com/docs/cms/building-blocks/modules/configuration) parameters in your meta.json file (Linked Files section in Design Tools). This only works with modules in themes, and will not work for standalone modules. 

### Template errors[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#template-errors)
...
![design-manager-errors-1](https://developers.hubspot.com/hubfs/Knowledge_Base_2023_2024/design-manager-errors-1.png "design-manager-errors-1")

Module compatibility with themes[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#module-compatibility-with-themes)
-----------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Theme providers define a new attribute called `alternate_names` which contains standard fields mapped to the module fields. Alternate names are supported for fonts and color fields. Module fields will [inherit](/docs/cms/building-blocks/module-theme-fields-overview#inherited-fields) from the standard color and font fields. This is a new attribute introduced for theme fields. For example:

{ "label": "ButtonColor", "name": "button\_color", "type": "color", "visibility": { "hidden\_subfields": { "opacity": true } }, "alternate\_names":\["primary\_color"\], "default": { "color": "#516747" } }
...
*   A user can [inherit](/docs/cms/building-blocks/module-theme-fields-overview#inherited-fields) either by defining `default_value_path` or `property_value_paths`, or both. Review the code snippet below for an example: 
...
\[ { "id" : "d506e41f-7206-bb8f-7fa5-d4a7de75c61e", "name" : "color", "display\_width" : null, "label" : "Color", "required" : false, "locked" : false, "type" : "color", "inherited\_value": { "default\_value\_path": "theme.primary\_color", "property\_value\_paths": { "color": "theme.primary\_color.color", "opacity": "theme.primary\_color.opacity" } }, "default" : { "color" : "#00FF03", "opacity" : 100 } } \]

*   In the `module.html`, these fields can be referred to with the following dot notation:

{{ theme.primary\_color }} <br> {{ theme.primary\_color.color }} <br> {{ theme.primary\_color.css }}
...
{ "label": "Colors", "name": "colors", "type": "group", "children": \[ { "label": "Primary", "name": "primary", "type": "color", "visibility": { "hidden\_subfields": { "opacity": true } }, "alternate\_names" : \["primary\_color"\] "default": { "color": "#516747" } }\] }
...
{ "label": "Fonts", "name": "fonts", "type": "group", "children": \[ { "label": "Primary", "name": "primary", "type": "font", "visibility": { "hidden\_subfields": { "bold": true, "italic": true, "size": true, "underline": true } }, "default": { "color": "#231f20", "fallback": "sans-serif", "font": "Montserrat", "font\_set": "GOOGLE", "variant": "400" }, "alternate\_names":\["heading\_font"\] }

Marketplace listing approval review process[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#marketplace-listing-approval-review-process)
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Disclaimers[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#disclaimers)
-----------------------------------------------------------------------------------------------------------------------

### The submission queue[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#the-submission-queue)
...
Our team is dedicated to completing reviews as quickly as possible without compromising quality or thoroughness. Following the [directions and requirements](https://developers.hubspot.com/docs/cms/marketplace-guidelines/listing-templates) for submitting and listing your templates will help to ensure your template passes review.

### Support for published templates[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#support-for-published-templates)
...
You must offer email support for your template(s) and provide documentation via a publicly accessible URL. Documents like PDFs and Google Docs can be used as supplemental resources, but the publicly accessible URL must be a live webpage.  Tickets, phone, live chat, and Facebook Messenger are all optional forms of support. 

### Self-reviews for listed templates are not allowed[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#self-reviews-for-listed-templates-are-not-allowed)
...
### Customer requests for receipt of purchase[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#customer-requests-for-receipt-of-purchase)
...
### Template listing removal and rejection[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#template-listing-removal-and-rejection)
...
*   Incompatibility with [HubSpot's supported browsers](https://knowledge.hubspot.com/resources/which-browsers-are-supported-by-hubspot)
...
*   Independent module listings will be removed if the module affects other elements of the page (view Module Requirements [here](/docs/cms/marketplace-guidelines/module-requirements#5-module-code-quality)).

### Template rejections[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#template-rejections)
...
### For All Participants[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#for-all-participants)
...
Share your feedback[](https://developers.hubspot.com/docs/cms/marketplace-guidelines/template-marketplace-policies#page-feedback)
---------------------------------------------------------------------------------------------------------------------------------

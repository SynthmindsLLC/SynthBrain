...
## New highlights added April 12, 2024 at 5:53 AM
- `range` and `sum` available, which respectively create a collection of numbers within a range and compute the sum of a collection of numbers: ([View Highlight](https://read.readwise.io/read/01hv7vm87akyst648bpeyymkqv))
- good programming language helps the programmer by allowing them to talk about the actions that the computer has to perform on a higher level. It helps omit details, provides convenient building blocks (such as `while` and `console.log`), allows you to define your own building blocks (such as `sum` and `range`), and makes those blocks easy to compose. ([View Highlight](https://read.readwise.io/read/01hv7vn6tccq17tzc5cp9qyrtj))
- There are those who will say *terrible* things about JavaScript. Many of these things are true. When I was required to write something in JavaScript for the first time, I quickly came to despise it. It would accept almost anything I typed but interpret it in a way that was completely different from what I meant. ([View Highlight](https://read.readwise.io/read/01hv7vqpqp42fk8f5acxpvr104))
- The idea behind this design was that it would make programming in JavaScript easier for beginners. In actuality, it mostly makes finding problems in your programs harder because the system will not point them out to you. ([View Highlight](https://read.readwise.io/read/01hv7vrwjkd6ny5cte0dfe9jsw))
- Some databases, such as MongoDB and CouchDB, use JavaScript as their scripting and query language. Several platforms for desktop and server programming, most notably the Node.js project (the subject of [Chapter 20](https://eloquentjavascript.net/20_node.html)), provide an environment for programming JavaScript outside of the browser. ([View Highlight](https://read.readwise.io/read/01hv7vvfs988d8tbwjhnk78eyy))

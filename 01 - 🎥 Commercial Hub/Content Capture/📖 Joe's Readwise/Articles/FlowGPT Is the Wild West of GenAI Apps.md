...
- Author: [[Kyle Wiggers]]
- Date: 2024-02-26
- Full Title: FlowGPT Is the Wild West of GenAI Apps
- Category: #articles
- Summary: FlowGPT is an alternative to OpenAI's GPT Store, which is a marketplace for AI-powered chatbots. FlowGPT is an ecosystem for GenAI-powered apps, a collection of infrastructure and creator tools tied to a community of GenAI app users. The platform has some moderation problems, with some apps potentially causing harm or breaking rules. Despite this, FlowGPT is expanding with a revamped mobile experience, revenue-sharing model for app creators, and a mission to cultivate a more open and creator-focused platform.
- URL: https://techcrunch.com/2024/02/26/flowgpt-is-the-wild-west-of-genai-apps/

## Highlights
- Through FlowGPT, users can build their own GenAI-powered apps and make them publicly available, earning tips for their contributions. ([View Highlight](https://read.readwise.io/read/01hqkyzfjrshsvb2wnxgshevgv))
- Jay Dang, a UC Berkeley computer science dropout, and Lifan Wang, a former engineering manager at Amazon, co-founded FlowGPT last year out of a shared desire to create a platform where people could quickly spin up — and share — GenAI apps. ([View Highlight](https://read.readwise.io/read/01hqkyztppa1ymexszbbnz81w3))
- Users interact with GenAI apps on FlowGPT through a chat window that’s not dissimilar to [ChatGPT](https://techcrunch.com/tag/chatgpt/), with options to type in prompts, thumbs-up (or thumbs-down) apps, share links to conversations or tip individual app creators. Each app has a creator-provided description along with the date it was created, how many times it’s been used and the model the creator recommends to power it. ([View Highlight](https://read.readwise.io/read/01hqkz0k3p2ck70nhrm65ncwpe))
- You’ll notice the heavy reliance on ChatGPT. Use FlowGPT long enough, and you’ll also notice that many of the prompts break when the model’s switched from the default. ([View Highlight](https://read.readwise.io/read/01hqkz1bayvgvgz187ca97v702))

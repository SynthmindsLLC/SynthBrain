...
00:22 - Guest's Journey into AI and Chatbots  
01:35 - Exploring Make.com and its Capabilities  
01:47 - Building a Personal Assistant Agent  
04:59 - The Role of JSON in the Process  
07:46 - Demonstration of the Chatbot  
11:05 - Understanding the Complexities of the Chatbot  
20:08 - Challenges Faced During the Building Process  
24:42 - Future Plans and Cost Analysis  
27:18 - Introduction to the Personal AI Assistant  
27:42 - Exploring the Potential of Open Source CRM  
28:51 - Challenges in Handling Personal Information  
29:39 - The Future of Personal AI Assistants  
32:38 - The Power of Automation and Learning from Mistakes  
34:59 - The Role of AI in Enhancing Productivity  
36:35 - The Evolution of Technology and its Impact on Productivity  
48:20 - The Power of Perplexity AI in Web Browsing  
52:53 - Future Plans for the Personal AI Assistant

Don't forget to like, share, and subscribe to our channel for more sessions like this!

## Linkedin
🚀 Exciting News for AI Enthusiasts! 🚀

@Joseph Rosenbaum, MSW had the pleasure of hosting @Sjoerd Tiemensma from the Netherlands in our latest "Learning in Public - Make Agents" session. Sjoerd shared his inspiring journey of building a personal AI assistant using OpenAI's API and Make.com. 🤖✨

From automating mundane tasks to managing his schedule, Sjoerd's AI assistant is a testament to the power of AI in enhancing our daily productivity. He also gave us a sneak peek into his future plans, which include integrating an open source CRM for personal relationships into his AI system. 📅💡

The session is packed with insights, demonstrations, and discussions on the challenges and future of personal AI assistants. Whether you're a tech pro or just AI-curious, there's something for everyone in this talk.

🎥 Check out the full session on YouTube! 

👉 Stay tuned for more updates and feel free to reach out if you're interested in learning more about AI and automation. Let's embrace the future of technology together!

[#AI](app://obsidian.md/index.html#AI) [#OpenAI](app://obsidian.md/index.html#OpenAI) [#Automation](app://obsidian.md/index.html#Automation) [#Productivity](app://obsidian.md/index.html#Productivity) [#MakeAgents](app://obsidian.md/index.html#MakeAgents) [#PersonalAssistant](app://obsidian.md/index.html#PersonalAssistant) [#TechTalk](app://obsidian.md/index.html#TechTalk)

# Make Agents Transcript
...
**Sjoerd:** we'll see. I still need to,~~ uh,~~ to develop it a bit more, and I think then,~~ um,~~ once I've got the,~~ um,~~ like the CRM, the relationship manager in there,~~ um,~~ I think that will be like ~~a, ~~a big step. And then we'll see what I, we'll do, I'll make of it afterwards. ~~Um, ~~yeah.
